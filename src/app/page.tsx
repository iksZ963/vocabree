    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <main className="flex-1">
        ...
        <section className="w-full py-16 md:py-20 lg:py-24 bg-gradient-to-b from-blue-50 to-purple-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center space-y-6 text-center">
              {/* Hero Title */}
              <h1
                className="text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-slate-900 animate-fade-in-up" style={{ fontFamily: 'Roboto, sans-serif' }}
        ...
        <section id="features" className="w-full py-16 md:py-20 bg-gradient-to-b from-purple-50 to-pink-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-center mb-12 text-slate-900" style={{ fontFamily: 'Roboto, sans-serif' }}>Features</h2>
            <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-3">
              ...
              <Card className="transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-none bg-white/80 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardTitle className="text-2xl font-semibold text-slate-800" style={{ fontFamily: 'Roboto, sans-serif' }}>Daily Word</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-slate-600 text-lg" style={{ fontFamily: 'Roboto, sans-serif' }}>
              ...
              <Card className="transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-none bg-white/80 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardTitle className="text-2xl font-semibold text-slate-800" style={{ fontFamily: 'Roboto, sans-serif' }}>Example Sentences</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-slate-600 text-lg" style={{ fontFamily: 'Roboto, sans-serif' }}>
              ...
              <Card className="transition-all duration-300 hover:shadow-xl hover:-translate-y-2 border-none bg-white/80 backdrop-blur-sm">
                <CardHeader>
                  ...
                  <CardTitle className="text-2xl font-semibold text-slate-800" style={{ fontFamily: 'Roboto, sans-serif' }}>Pronunciation Guide</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-slate-600 text-lg" style={{ fontFamily: 'Roboto, sans-serif' }}>
        ...
        <section id="why-vocabree" className="w-full py-16 md:py-20 bg-gradient-to-br from-pink-50 to-blue-50">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-center mb-12 text-slate-900" style={{ fontFamily: 'Roboto, sans-serif' }}>Why Vocabree?</h2>
            <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-3">
              {/* Why Vocabree Cards */}
              <div className="flex flex-col items-center text-center transition-all duration-300 hover:transform hover:scale-105 bg-white/80 backdrop-blur-sm p-10 rounded-2xl shadow-lg">
                ...
                <p className="text-slate-600 text-lg" style={{ fontFamily: 'Roboto, sans-serif' }}>
